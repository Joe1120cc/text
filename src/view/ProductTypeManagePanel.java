...
public class ProductTypeManagePanel extends JPanel {
	...
	public ProductTypeManagePanel() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				CreateProductTypeJFrame frame = new CreateProductTypeJFrame();
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				SearchProductTypeJFrame frame = new SearchProductTypeJFrame();
				frame.setVisible(true);
		...
		btnNewButton_2.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				ChangeProductTypeJFrame frame = new ChangeProductTypeJFrame();
				frame.setVisible(true);
		...
		btnNewButton_2_1.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				DeleteProductTypeJFrame frame = new DeleteProductTypeJFrame();
				frame.setVisible(true);
		...
		JLabel lblNewLabel = new JLabel("产品类别列表");
	...
	public static void initTable() {
		...
		List<Object> data = FileUtils.getData("ProductTypes.txt", ProductType.class);
		vName.add("序号");
		vName.add("类别名称");
		int i = 1;
		for (Object o : data) {
