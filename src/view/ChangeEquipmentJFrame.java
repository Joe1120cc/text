	...
	public ChangeEquipmentJFrame(String equipmentID) {
		...
		btnNewButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				Equipment eq = new Equipment(equipmentID, equipmentName, et, equipmentSpecification,
						E.getEquipmentOwnedFactory(), E.getEquipmentDescription(), E.getEquipmentState(),
						E.getRentState());
