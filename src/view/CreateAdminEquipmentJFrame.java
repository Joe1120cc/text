 ...
 * @author 刘超20195556
 * @Date Jul 22, 2020
 * @Description 超级管理员新建设备Jframe
 */
public class CreateAdminEquipmentJFrame extends JFrame {
	 ...
	 * Create the frame.
	 */
	public CreateAdminEquipmentJFrame() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				while (Tool.isEquipmentIDExisted(equipmentID)) {
					equipmentID = "EMT" + (new Random().nextInt(899999999) + 100000000);
				}
				...
				Equipment ep = new Equipment(equipmentID, equipmentName, et, equipmentSpecification, null,
						equipmentDescription, "已关闭", "未被租用");
